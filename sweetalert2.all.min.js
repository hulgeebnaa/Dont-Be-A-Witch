!(function (t, e) {
  ...
  var yt = {
    ...
    Pt = {};
  (Pt.text = Pt.email = Pt.password = Pt.number = Pt.tel = Pt.url = function (
    t,
    e
  ) {
    return (
  ...
  var _t = {},
    zt = {
      ...
      showCancelButton: !1,
      preConfirm: void 0,
      confirmButtonText: "ЭНЭХҮҮ ТОГЛООМЫГ ТОГЛОЖ БАЙГААД БАЯРЛАЛАА",
      confirmButtonText2: "--------- БАЯР ХҮРГЬЕ --------- Батхүлэгээс",
